...
.wm-button{user-select: none; margin: 0 4px; border: transparent 1px solid; background: none; cursor: pointer; font-size: 14px; text-align: center; box-sizing: border-box; white-space:normal}
.wm-button:hover{box-shadow: 0 2px 4px rgba(0,0,0,.2);}
.wm-button:disabled{opacity: 0.5; cursor: not-allowed;}
.wm-button i{font-size: 12px;}
/* default */
...
.wm-button.text_primary:hover{box-shadow: none; border-color: @Primary;}
/* success */
...
.wm-button.text_success:hover{box-shadow: none; color: @Success1; border-color: @Success1;}
/* warning */
...
.wm-button.text_warning:hover{box-shadow: none; color: @Warning1; border-color: @Warning1;}
/* danger */
...
.wm-button.text_danger:hover{box-shadow: none; color: @Danger1; border-color: @Danger1;}
/* info */
...
.wm-button.text_info:hover{box-shadow: none; color: @Info1; border-color: @Info1;}
</style>
...
@Options({
  ...
  props: {
    ...
    height: {type: String, default: '36px'},          // 高度
    padding: {type: String, default: '0 24px'},       // 内部间距
