...
export function en_US(): any {
  return {
    ...
    key: 'Keywords',
    sku_id: 'Please enter the product code',
    print_template: 'Search for printing templates',
    ...
    total_info: (num: number) => { return 'There are a total of <b>' + (num || 0) + '</b> items'; },
    del_warn: (num: number) => { return 'Delete <b>' + num + '</b> pieces of data'; },
    del_part_warn: (total: number, num: number) => { return '<b>' + total + '</b> items in total， <b>' + num + '</b> items can be deleted'; },
