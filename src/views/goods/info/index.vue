...
const list = ref({columns: [
  ...
  {title: '商品名称', index: 'name', order: '', textAlign: 'center'},
  {title: '颜色及规格', index: 'properties_value', textAlign: 'center'},
  {title: '成本价(元)', index: 'cost_price', slot: 'cost_price', order: '', textAlign: 'center'},
  {title: '供应链价(元)', index: 'supply_price', slot: 'supply_price', order: '', textAlign: 'center'},
  {title: '标签价(元)', index: 'sale_price',  slot: 'sale_price', order: '', textAlign: 'center'},
  {title: '采购价(W)', index: 'purchase_price', slot: 'purchase_price', order: '', textAlign: 'center'},
  {title: '人民币采购价(元)', index: 'supplier_price', slot: 'supplier_price', order: '', textAlign: 'center'},
  {title: '吊牌价(W)', index: 'market_price', slot: 'market_price', order: '', textAlign: 'center'},
