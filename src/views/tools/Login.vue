...
.wm-login_logo{margin: 48px auto; width: 160px; height: 160px; border: @Minor 1px solid; background-color: rgba(0,0,0,0.7); border-radius: 50%; background-repeat: no-repeat; background-position: center;}
