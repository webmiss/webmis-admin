...
.wm-login_bg.bg3{background-image: url('/bg/3.jpg');}
.wm-login_bg.bg4{background-image: url('/bg/4.jpg');}
.wm-login_bg.bg5{background-image: url('/bg/5.jpg');}
.wm-login_bg.bg6{background-image: url('/bg/6.jpg');}
.wm-login_bg.bg7{background-image: url('/bg/7.jpg');}
.wm-login_bg.bg8{background-image: url('/bg/8.jpg');}
.wm-login_bg.bg9{background-image: url('/bg/9.jpg');}
...
.wm-login_bottom{padding: 16px 0; line-height: 40px; text-shadow: 0 0 8px #000; display: flex; justify-content: center; align-items: center;}
.wm-login_bottom span{display: flex; justify-content: center; align-items: center; padding: 0 16px; color: @Minor6;}
.wm-login_bottom i{cursor: pointer; width: 40px; height: 40px; margin: 0 8px; border-radius: 50%; display: flex; justify-content: center; align-items: center;}
